...
local HardCore = {
    Title = "FIRST PAIN", -- Made by MuhammadGames and Volta
    Desc = "Join a Match of HardCore For the First Time enjoy the suffering.",
...
local Depth = {
    ...
    Desc = "It's So Cold first depth death",
...
local Smiley = {
    Title = "truth has come",
    Desc = "survived the weird smiling png",
    Reason = "Encounter and Survive Smiley",
        ...
        while true do task.wait()
            pcall(function()
                ...
                local entity = Creator.createEntity({
                    ...
                    Model = "https://github.com/PABMAXICHAC/doors-monsters-models/blob/main/Smiley.rbxm", -- Can be GitHub file or rbxassetid
                    Speed = 851, -- Percentage, 200 = default Rush speed
